...
--
ALTER TABLE `userroles`
  ADD CONSTRAINT `fkRoleID_UserRoles` FOREIGN KEY (`RoleID`) REFERENCES `roles` (`RoleID`) ON DELETE CASCADE,
  ADD CONSTRAINT `fkUserID_UserRoles` FOREIGN KEY (`UserID`) REFERENCES `user` (`UserID`) ON DELETE CASCADE;
COMMIT;
